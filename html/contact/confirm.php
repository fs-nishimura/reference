...
<!-- shoplist -->
        <div class="content_box">
            ...
            <form action="confirm.php" method="post">
              ...
              <div class="box-btn">
                <a class="form-btn" href="./"><img src="../img/contact/btn-reset.gif" alt="RESET" width="156" height="42" ></a>
          ...
          <?php else: ?>
          <p class="read">下記の内容で送信いたします。<br />
ご確認の上、よろしければSUBMITボタンを押して送信してください。</p>
          <div class="content_box">
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="form-confirm">
          <tr>
          <th><em>NAME</em><span></span></th>
          <td nowrap><?php print($_POST['name']); ?>
          </td>
          </tr>
          <tr>
          <th><em>E-MAIL</em><span></span></th>
          ...
          <div class="box-btn">
            ...
            <input type="hidden" name="tel" value="<?php print($_POST["tel"]); ?>">
            <input type="hidden" name="tel" value="<?php print($_POST["company"]); ?>">
            <input type="hidden" name="text" value="<?php print($_POST["text"]); ?>">
            ...
            <input type="hidden" name="email" value="<?php print($_POST["email"]); ?>">
            <input type="hidden" name="tel" value="<?php print($_POST["tel"]); ?>">
            <input type="hidden" name="text" value="<?php print($_POST["company"]); ?>">
            <input type="hidden" name="text" value="<?php print($_POST["text"]); ?>">
